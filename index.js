...
// app.use(express.static(path.join(__dirname, "./ecom-frontend-practice-1/ecom-dashboard-practice-1/dist")));
// app.get("*", (req, resp) => {
//     resp.sendFile(path.join(__dirname, "./ecom-frontend-practice-1/ecom-dashboard-practice-1/dist/index.html"))
// })
